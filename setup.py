...
PACKAGE_NAME = 'fabric-django'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/fabric-django/archive/master.zip'  # .tar.gz
URL = 'https://github.com/Nekmo/fabric-django'  # Project url
STATUS_LEVEL = 1  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['fabric-django', 'fabric', 'django', 'deploy']
...
DESCRIPTION = """\
Django deployment system for Fabric
"""
